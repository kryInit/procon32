...
SingleProcedure::SingleProcedure() : selected_pos(), path() {}
SingleProcedure::SingleProcedure(Pos selected_pos, Path path) : selected_pos(selected_pos), path(std::move(path)) {}
